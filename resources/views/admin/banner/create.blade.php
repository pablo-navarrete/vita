...
<div class="container contenedor">
    <div class="row">
        ...
        <div class="col-md-4">
            <p class="text-end mb-0 my-auto"><a href="{{ route('admin.banner.index') }}">Banner</a> / Crear Banner</p>
        </div>
    </div>
    ...
    <div class="col-md-12 mt-4">
        ...
        <div class="card">
            ...
            <form id="bannerForm" method="POST" action="{{ route('admin.banner.store') }}" enctype="multipart/form-data">
                @csrf
                ...
                success: function(response) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = '/admin/banner'; // Cambia la URL según sea necesario
                        }
                    });
                },
