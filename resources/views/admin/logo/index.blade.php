            ...
            <div class="card">
                ...
                <div class="card-body row mx-0">
                    ...
                    <div class="col-6 text-center">
                        @if($logo)
                        <img src="{{ asset('storage/' . $logo->image_url) }}" alt="Logo" style="width: 200px; height: 200px;">
                        @else
                        No hay logo
                        @endif
                    </div>
                    <div class="col-6 ">
                        <form id="logoForm" method="POST" enctype="multipart/form-data" action="{{ route('admin.logo.store') }}">
                ...
                success: function(response) {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            // Redirigir a la ruta 
                            window.location.href = '/admin/logo'; // Cambia la URL según sea necesario
                        }
                    });
                },
